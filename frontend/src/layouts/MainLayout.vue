<template>
  <div class="flex h-full overflow-hidden">
    ...
    <main class="flex-1 bg-base-100 flex flex-col min-w-0 relative">
      ...
      <!-- Desktop Footer -->
      <footer class="hidden lg:block h-8 border-t border-base-300 bg-base-100 shrink-0">
        <div class="h-full flex items-center justify-center text-xs text-base-content/50">
          © oinote
        </div>
      </footer>
    </main>
